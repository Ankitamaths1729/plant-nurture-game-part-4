...
co2=loadImage("images/co2.png");
 ...
 cloud=loadImage("images/gas cloud.png");
...
bubbleSprite.visible=true;
 ...
 sacSprite.visible=true;
    ...
    function preload(){
     ...
     cloud=loadAnimation("images/cloud (1).png");
     cloudreplace = loadAnimation("images/cloud (1).png");
    sun=loadImage("images/sun.png");
    ...
    bubbleSprite.visible=true;
     ...
     sacSprite.visible=true;
        ...
        if(mousePressedOver( sacSprite &&  canSprite && cloudSprite && cloud1Sprite )){
        gameState="win"
        fill("yellow"); 
         textSize(40); 
